...
for $n \in \mathbb{N}$ such that $\mathcal{V}$ is the set of all nodes [8] and $1$ and $2$ represent the first and second nodes, for example.  The number of nodes $N$ is then just the cardinality of $\mathcal{V}$ such that $N = |\mathcal{V}|$ .  Then, for a single-layer Erdős–Rényi graph $G_{NP}$ , [8] that is to say a two-dimensional graph with no coupling constant $D_x$ [6], this is defined as the adjacency matrix $A$ such that 
...
where $E$ is the set of all edges [8] such that 
...
where $d_i = \sum_i A_{ij}$ for the $i$-th node [8].  The unnormalized Laplacian matrix $L$ is then given by the equation
...
[1] Anand, K., & Bianconi, G. (2009). Entropy measures for networks: Toward an information theory of complex topologies. *Physical Review E,* *80*(4). doi:10.1103/physreve.80.045102

[2] Avrim Blum: CS 598 (CRN 62819) topics in Algorithms (2015). (n.d.). Retrieved March 29, 2021, from https://www.cs.cmu.edu/~avrim/598/

[3] Barré, J., Carrillo, J. A., Degond, P., Peurichard, D., & Zatorska, E. (2017). Particle interactions mediated by dynamical networks: Assessment of macroscopic descriptions. *Journal of Nonlinear Science,* *28*(1), 235-268. doi:10.1007/s00332-017-9408-z

[4] Bianconi, G. (2015). Interdisciplinary and physics challenges of network theory. *EPL (Europhysics Letters),* *111*(5), 56001. doi:10.1209/0295-5075/111/56001

[5] De Domenico, M., & Biamonte, J. (2016). Spectral entropies As INFORMATION-THEORETIC tools for complex Network comparison. *Physical Review X,* *6*(4). doi:10.1103/physrevx.6.041062

[6] Jolliffe, I. T., & Cadima, J. (2016). Principal component analysis: A review and recent developments. *Philosophical Transactions of the Royal Society A: Mathematical, Physical and Engineering Sciences,* *374*(2065), 20150202. doi:10.1098/rsta.2015.0202

[7] Kobayashi, T., & Onaga, T. (2021). Dynamics of diffusion on MONOPLEX and MULTIPLEX Networks: A message-passing approach. *SSRN Electronic Journal*. doi:10.2139/ssrn.3806211

[8] Li, Z., Mucha, P. J., & Taylor, D. (2018). Network-Ensemble comparisons with Stochastic rewiring and Von Neumann entropy. *SIAM Journal on Applied Mathematics,* *78*(2), 897-920. doi:10.1137/17m1124218